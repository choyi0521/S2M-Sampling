...
class Generator(nn.Module):
    ...
    def forward(self, z, label=None, class_weight=None, shared_label=None, eval=False):
            ...
            if self.g_cond_mtd != "W/O":
                ...
                if shared_label is None:
                    if class_weight is None:
                        ...
                        class_numbers = torch.arange(self.num_classes, device=z.get_device())
                        shared_label = torch.mm(class_weight, self.shared(class_numbers))
                else:
                    pass
